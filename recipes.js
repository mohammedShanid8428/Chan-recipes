const recipes = [
  ...
  },
  {
    ...
    description:
      "Chicken Biryani is a royal and aromatic dish made by layering marinated chicken with long-grain basmati rice, cooked with whole spices and herbs. The chicken is typically marinated in yogurt, spices, and fried onions, making it tender and flavorful. It’s then slow-cooked using the dum method, allowing the flavors to infuse deeply into every grain of rice. Garnished with fresh mint, coriander, and a drizzle of ghee, this dish is the ultimate centerpiece for festive meals and celebrations.",
    ...
    instructions: [
      ...
      "Seal the lid with dough or cover tightly with foil and cook on low flame (dum) for 25–30 minutes.",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Heat oil and sauté onions, ginger-garlic paste, and curry leaves until golden brown.",
      ...
      "Add water, cover, and pressure cook until the mutton is tender (about 4–5 whistles).",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Stir in ginger-garlic paste and curry leaves, and sauté until the raw smell disappears.",
      "Add chopped tomatoes and cook until soft.",
      "Add all the ground spices – turmeric, chili powder, coriander powder, and garam masala. Cook until the oil separates from the masala.",
      "Add cleaned beef cubes to the masala and sauté on high flame for 5–7 minutes until lightly browned and well-coated.",
      "Pour enough water to cover the meat and pressure cook for 5–6 whistles or until the beef is tender.",
